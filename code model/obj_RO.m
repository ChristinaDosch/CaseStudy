function [obj, grad] = obj_RO(x,e_l,e_u,cost,penalty,penalty_grad,epsilon,P,SmoothOrNonSmooth)
% [obj, grad] = OBJ_RO(x,p_l,p_u,cost,penalty,penalty_grad,epsilon,P,SmoothOrNonSmooth)
