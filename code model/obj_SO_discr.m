function [obj,grad_x,grad_SOC_b] = obj_SO_discr(x,e,cost,penalty,penalty_grad,epsilon,P,var,penalty_hess)
...
[yp,gradp,~] = smooth_ppart((x - epsilon*P) - E,1E-3,5);
[yc,gradc,~] = smooth_ppart(E - (x + epsilon*P),1E-3,5);
