...
x_tilde = @(x) battery_smart(E(k,:),x,T,P,cost,penalty,penalty_grad,epsilon, A_smart, b_smart, SOC_min, SOC_max); % computes optimal x_tilde as e^k 0.95 \tilde{b^out,k}_opt - \tilde{b^in,k}_opt
