...
Bern <- read.table("Bern-hour.dat", header=FALSE)
Bern <- Bern[,1:5]
Bern$V4 <- NULL
...
# Store combinded plots in PDF: 
pdf("SommerPlots.pdf")
## -------------------------- Combinded Plots Summer -------------------------------- ##
plot(BernSSW$Hour, BernSSW$Radiation, lwd = 3, cex.main=3, cex.lab=2, cex.axis=2, xlab = "Hour", ylab = "Radiation in Wh/sq m", main="Summer Solstice", type = "l", col = "green")
lines(SanFranciscoSSW$Hour, SanFranciscoSSW$Radiation,lwd = 3,  col= "red")
lines(JohannisburgSSW$Hour, JohannisburgSSW$Radiation,lwd = 3,  col= "blue")
lines(PerthSSW$Hour, PerthSSW$Radiation, lwd = 3, col= "orange")
lines(BrasilSSW$Hour, BrasilSSW$Radiation,lwd = 3,  col= "purple")

legend ("topright",c("Bern","SanFrancisco","Brasilia", "Johannisburg","Perth"), lty=c(1,1,1,1,1), lwd=c(1,2,2,2,2),col=c("green","red","purple","blue","orange"))
dev.off()
## -------------------------- Combinded Plots Winter -------------------------------- ##

pdf("WinterPlots.pdf")
plot(JohannisburgWSW$Hour, JohannisburgWSW$Radiation, xlab = "Hour", ylab = "Radiation in Wh/sq m", main="Winter Solstice", type = "l", col = "blue")
...
legend ("topright",c("Bern","SanFrancisco","Brasilia", "Johannisburg","Perth"), lty=c(1,1,1,1,1), lwd=c(1,2,2,2,2),col=c("green","red","purple","blue","orange"), cex=1.25)
...
pdf("SommerPlotR3.pdf")
par(mar=c(5,5,4,2)+0.1)
plot(BernSSW$Hour, BernSSW$Radiation/1000,lwd = 3,  cex.main=3, cex.lab=2, cex.axis=1.5, font.main = 1, xlab = "time in h", ylab = "radiation in KWh/sq m", main="Summer Solstice", type = "l", col = "green")
lines(SanFranciscoSSW$Hour, SanFranciscoSSW$Radiation/1000,lwd = 3,  col= "red")
lines(JohannisburgSSW$Hour, JohannisburgSSW$Radiation/1000,lwd = 3,  col= "blue")
lines(PerthSSW$Hour, PerthSSW$Radiation/1000,lwd = 3,  col= "orange")
lines(BrasilSSW$Hour, BrasilSSW$Radiation/1000,lwd = 3,  col= "purple")
legend ("topright",c("Bern","San Francisco","Brasilia", "Johannisburg","Perth"), lty=c(1,1,1,1,1), lwd=c(1,2,2,2,2),col=c("green","red","purple","blue","orange"), cex=1.2)
dev.off()

pdf("WinterPlotR3.pdf")
par(mar=c(5,5,4,2)+0.1)
plot(JohannisburgWSW$Hour, JohannisburgWSW$Radiation/1000,lwd = 3,  cex.main=3, cex.lab=2, cex.axis=1.5, font.main = 1,xlab = "time in h", ylab = "radiation in KWh/sq m", main="Winter Solstice", type = "l", col = "blue")
lines(SanFranciscoWSW$Hour, SanFranciscoWSW$Radiation/1000, lwd = 3, col= "red")
lines(PerthWSW$Hour, PerthWSW$Radiation/1000,lwd = 3,  col= "orange")
lines(BernWSW$Hour, BernWSW$Radiation/1000,lwd = 3,  col= "green")
lines(BrasilWSW$Hour, BrasilWSW$Radiation/1000,lwd = 3,  col= "purple")
legend ("topright",c("Bern","San Francisco","Brasilia", "Johannisburg","Perth"), lty=c(1,1,1,1,1), lwd=c(1,2,2,2,2),col=c("green","red","purple","blue","orange"), cex=1.2)
dev.off()
